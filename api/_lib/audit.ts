...
export function recordAudit(transaction: Transaction, input: { entityType: 'customer' | 'invoice' | 'payment' | 'expense' | 'plan'; entityId: number; action: string; reason?: string; details?: unknown }) {
