...
const tables = ['business_settings', 'areas', 'plans', 'customers', 'customer_status_history', 'customer_plan_history', 'customer_plan_gaps', 'invoices', 'invoice_charges', 'invoice_merge_items', 'payments', 'payment_allocations', 'expenses', 'audit_events', 'id_sequences'] as const
