...
export type InvoiceDetail = Invoice & { customerCode: string; phone?: string | null; areaName: string; planName: string; stbNumber: string | null; monthsBilled: number; currentPeriodAmountPaise: number; previousDueSnapshotPaise: number; liveBalancePaise: number; currentCustomerDuePaise: number; historicalReason?: string | null; charges: Array<{ chargeType: string; description: string; amountPaise: number }>; allocations: Array<{ paymentCode: string; paymentDate: string; periodStart: string; periodEnd: string; chargeType?: string | null; cashPaise: number; discountPaise: number; creditPaise: number }>; mergeItems: Array<{ invoiceCode: string; planName: string; periodStart: string; periodEnd: string; amountPaise: number }> }
export type Payment = { id: number; paymentCode: string; customerId: number; customerName: string; paymentDate: string; amountReceivedPaise: number; discountGivenPaise: number; settledAmountPaise: number; paymentMode: 'cash' | 'upi' | 'system_credit'; resultingStatus: string; notes?: string | null; allocations?: Array<{ invoiceCode: string; periodStart: string; periodEnd: string; chargeType: string; cashPaise: number; discountPaise: number; creditPaise: number }> }
export type PaymentDetail = Payment & { customerCode: string; phone?: string | null; stbNumber: string | null; areaName: string; allocations: Array<{ invoiceCode: string; periodStart: string; periodEnd: string; chargeType?: string | null; cashPaise: number; discountPaise: number; creditPaise: number }> }
...
export function createInvoice(serviceType: ServiceType, input: { customerId: number; monthsBilled: number; expectedPeriodStart: string; periodStart?: string; issuedDate?: string; billingMode?: 'normal' | 'historical'; historicalReason?: string }) { return request<{ invoiceCode: string; periodStart: string; periodEnd: string; nextEligibleDate: string; replayed: boolean }>('/api/invoices', { method: 'POST', body: JSON.stringify({ serviceType, ...input }) }) }
