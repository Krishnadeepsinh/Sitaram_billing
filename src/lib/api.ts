...
export function bulkCreateInvoices(serviceType: ServiceType, throughMonth: string, customerIds?: number[], preview = false, issuedDate?: string) { return request<BulkInvoiceResult>('/api/invoices/bulk', { method: 'POST', body: JSON.stringify({ serviceType, throughMonth, customerIds, preview, ...(issuedDate ? { issuedDate } : {}) }) }) }
